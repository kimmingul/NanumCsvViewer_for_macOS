...
Nanum CSV Viewer for macOS의 첫 정식 릴리즈입니다.

### Highlights

- 앱 아이콘 추가 및 macOS `.app` bundle icon 설정
- Bundle version을 `1.0.0`으로 업데이트
- Swift/AppKit 기반 macOS 네이티브 대용량 CSV viewer
- 1GiB 이상 CSV 파일을 위한 byte offset indexing 및 virtual table rendering
...
- Developer ID Application 서명 및 Apple notarization/stapling 배포
